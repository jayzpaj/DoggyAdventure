...
import MazeBoard from '../MazeBoardLevels/MazeBoardLevel1';
import CongratulationsScreen from '../Screens/WinningLevel1';
import GameOverScreen from '../Screens/GameOverLevel1';
import generateBoard from '../MazeBoardLevels/InitialBoardLevel1';
...
const DoggyMaze = () => {
  ...
  return (
    <div className="doggy-maze-container">
      ...
      <h2 className="center-textsy">Time: {timer} seconds</h2>

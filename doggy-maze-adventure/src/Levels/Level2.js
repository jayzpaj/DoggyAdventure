...
import MazeBoard from '../MazeBoardLevels/MazeBoardLevel2';
import CongratulationsScreen from '../Screens/WinningLevel2';
import GameOverScreen from '../Screens/GameOverLevel2';
import generateBoard from '../MazeBoardLevels/InitialBoardLevel2';
import "../Css/ControlsLevel2.css"
...
const DoggyMaze = () => {
  ...
  const resetGameManually = useCallback(() => {
    ...
    setScore(0);
    setTimer(30); // Reset the timer to the initial value (adjust as needed)
  ...
  return (
    <div className="doggy-maze-container">
      <h1 className="center-textys">Level 2: Medium Game</h1>
      <h2 className="center-textsys">Score: {score}</h2>
      <h2 className="center-textsys">Time: {timer} seconds</h2>
